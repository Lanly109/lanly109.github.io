...
function init() {
    ...
    var settings = {
        ...
        image: '/img/avatar.jpg',//image path
        dropRadius: 1,//radius of the ripple
        width: 110,//width
        height: 110,//height
    ...
    var avatar = document.getElementById( 'author-avatar-img' );
    //init
    var waterRippleEffect = new WaterRipple( avatar, settings );
    ...
    document.onkeydown = function(e) {
        ...
        if(event && event.keyCode==13){ // enter 键
            waterRippleEffect.disturb(55, 55);
        }
    }
